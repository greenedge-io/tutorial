...
########################################################################### 
# import these files for downloading and extracting the files for training
import zipfile
import requests
import os
...
def download_zip(url):
    ...
    file_name = url.split("/")[-1] #get the last part as the name 
...
########################################################################### 
# download the file from the url and extract it
print (" * downloading the data ")
url = "https://www.dropbox.com/s/t0bpvw3477oglou/data.zip?dl=1"
